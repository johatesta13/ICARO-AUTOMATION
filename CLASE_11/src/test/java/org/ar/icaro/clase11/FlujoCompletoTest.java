package org.ar.icaro.clase11;

import com.fasterxml.jackson.annotation.JsonTypeInfo;
import org.ar.icaro.clase11.pages.*;
...
public class FlujoCompletoTest {
    ...
    public void CompraCompletaE2E(){
        ...
        InventoryPage inventory = loginPage.goTo().loginAs("standard_user","secret_sauce");

        Assert.assertTrue(inventory.isOnInventoryPage(), "Deberia estar en inventario");
        ...
        Assert.assertEquals(cart.getCartItemCound(), 2,
